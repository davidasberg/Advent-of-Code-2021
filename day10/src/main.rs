...
// impl Chunk {
//     fn new(is_balanced: bool, chunks: Box<Chunk>) -> Chunk {
//         Chunk {
...
//given a string, check whether it is balanced with 
